...
godot --headless --export-release "Linux/X11" $EXPORT_PATH/$FILE_NAME.$LINUX_FILE_EXTENSION
...
7z a $EXPORT_PATH/$EXPORT_LINUX_NAME.7z $EXPORT_PATH/$FILE_NAME.$LINUX_FILE_EXTENSION $EXPORT_PATH/godot-jolt_linux-x64.so
7z a $EXPORT_PATH/$EXPORT_WINDOWS_NAME.7z $EXPORT_PATH/$FILE_NAME.$WINDOWS_FILE_EXTENSION $EXPORT_PATH/godot-jolt_windows-x64.dll
